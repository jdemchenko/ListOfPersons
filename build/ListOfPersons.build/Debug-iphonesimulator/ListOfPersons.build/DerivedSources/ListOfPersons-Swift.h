...
#ifndef LISTOFPERSONS_SWIFT_H
#define LISTOFPERSONS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ListOfPersons",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13ListOfPersons11AppDelegate")
...
SWIFT_CLASS("_TtC13ListOfPersons27PersonDetailsViewController")
...
SWIFT_CLASS("_TtC13ListOfPersons34PersonsListOfDetailsViewController")
@interface PersonsListOfDetailsViewController : UITableViewController
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC13ListOfPersons24PesonsListViewController")
@interface PesonsListViewController : UITableViewController
- (void)viewDidLoad;
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC13ListOfPersons13SceneDelegate")
